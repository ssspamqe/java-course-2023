...
class ChaoticMazeGeneratorTest : StringSpec({

    var generator = ChaoticMazeGenerator()

    "Chaotic maze generator should generate maze for positive integer sizes" {
        checkAll(Arb.int(1..50), Arb.int(1..50)) { a, b ->
            generator.getMaze(a, b, 50)
        }
    }

    "Chaotic maze generator should throw exception if height or width not positive" {
